...
export default function NotFound() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 text-center">
      <div className="w-20 h-20 rounded-2xl bg-primary-light flex items-center justify-center mb-6 text-primary">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
          <path d="M6 9V2h12v7" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
          <rect x="2" y="9" width="20" height="9" rx="2" stroke="currentColor" strokeWidth="2"/>
          <path d="M6 14v6h12v-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
        </svg>
      </div>
      ...
      <div className="flex gap-3">
        <Link
          href="/"
          className="h-11 px-6 rounded-full bg-primary text-white font-bold text-sm hover:bg-primary-dark transition-colors"
        >
          Ir al inicio
        </Link>
        <Link
